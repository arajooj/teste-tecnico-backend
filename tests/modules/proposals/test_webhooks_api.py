...
def test_bank_callback_maps_simulation_approval(client, db_session, seeded_identity):
...
def test_bank_callback_maps_inclusion_rejection_and_accepts_duplicates(
    client,
    db_session,
    seeded_identity,
):
